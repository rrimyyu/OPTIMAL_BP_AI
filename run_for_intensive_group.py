...
x_df = is_cln_df.drop(['multi', 'optimal_bp_reg_no', 'mRS_3months'], axis = 1)
y_mrs_df = is_cln_df['mRS_3months']
...
plot_of_SHAP(model, X_valid, "INT_SHAP_CLN.svg")
plot_of_SHAP(model_bp, X_bp_valid, "INT_SHAP_ADDED.svg")
